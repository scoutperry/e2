...
class AppController extends Controller
{
    ...
    {
        return 'zipfoods is your one-stop-shop for convient online grocery shopping in the greater boston area';
    }

    public function practice()
    {
        # For XAMPP app the user and password defaults are
        # user : root
        # password: ""
        ...
        $sgl = "INSERT INTO reviews (name, review) VALUES (".$name.", ".$review.");
         
        #BEWARE the sql injection attack!
